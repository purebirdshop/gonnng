  ...
  return (
    <div className="max-w-4xl mx-auto px-4 lg:px-8 py-12 space-y-10 text-white/80">
      ...
      <div className="space-y-3 border-b border-white/10 pb-8">
        <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/30 px-3 py-1 rounded-full text-xs font-mono font-bold text-blue-400">
          <FileText className="w-3.5 h-3.5" />
          <span>Legal Agreement</span>
        </div>
        <h1 className="text-3xl font-extrabold text-white">Gonnng Terms of Service</h1>
        <p className="text-xs text-white/50 font-mono">Effective Date: July 2026 • Version 2.4</p>
      </div>

  ...
  return (
    <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12 space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* DESKTOP WEB CARD */}
        <div className="bg-gradient-to-b from-[#FF5C00]/15 to-transparent border border-[#FF5C00]/40 rounded-2xl p-6 space-y-6 flex flex-col justify-between shadow-xl">
          <div className="space-y-4">
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-white">Desktop Browser</h3>
              <p className="text-xs text-white/60 mt-1">Full-featured creative workspace in Chrome, Safari, Edge or Firefox</p>
            </div>
          ...
          <div className="space-y-2 pt-4 border-t border-white/10">
            <button
              ...
              className="w-full bg-gradient-to-r from-[#FF5C00] to-[#FF8000] text-white font-bold py-3 px-4 rounded-xl text-xs flex items-center justify-center gap-2 shadow-lg shadow-[#FF5C00]/25 hover:scale-105 transition-all cursor-pointer"
            >
              <span>Launch Web Workspace</span>
              <ArrowRight className="w-4 h-4" />
            </button>
            <span className="block text-[10px] text-center text-white/40 font-mono">Instant Access • No Install</span>
          </div>
        </div>

        {/* MOBILE WEB CARD */}
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-6 flex flex-col justify-between hover:border-[#FF5C00]/50 transition-colors">
          <div className="space-y-4">
            <div className="w-12 h-12 rounded-xl bg-white/10 text-white flex items-center justify-center">
              <Smartphone className="w-6 h-6" />
            </div>
            <div>
              <div className="inline-block px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 mb-1">
                AVAILABLE NOW
              </div>
              <h3 className="text-xl font-bold text-white">Mobile Browser</h3>
              <p className="text-xs text-white/60 mt-1">Optimized for iPhone, iPad, Android phones and tablets</p>
            </div>
            <ul className="space-y-2 text-xs text-white/70 font-sans">
              <li className="flex items-center gap-2">
                <Check className="w-4 h-4 text-emerald-400 shrink-0" />
          ...
          <div className="space-y-2 pt-4 border-t border-white/10">
            <button
              onClick={onOpenWorkspace}
              className="w-full bg-white/10 hover:bg-white/20 text-white font-bold py-3 px-4 rounded-xl text-xs flex items-center justify-center gap-2 transition-colors cursor-pointer border border-white/20"
            >
              <span>Open on Mobile Browser</span>
              <ArrowRight className="w-4 h-4 text-[#FF5C00]" />
            </button>
            <span className="block text-[10px] text-center text-white/40 font-mono">Works on iOS & Android Safari/Chrome</span>
          </div>
        </div>

        {/* NATIVE MOBILE APPS CARD (COMING SOON) */}
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-6 flex flex-col justify-between opacity-85 hover:opacity-100 transition-opacity">
          <div className="space-y-4">
            <div className="w-12 h-12 rounded-xl bg-purple-500/20 text-purple-400 flex items-center justify-center">
              <Clock className="w-6 h-6" />
            </div>
            <div>
              <div className="inline-block px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-purple-500/20 text-purple-300 border border-purple-500/30 mb-1">
                IN DEVELOPMENT
              </div>
              <h3 className="text-xl font-bold text-white">Native Mobile Apps</h3>
              <p className="text-xs text-white/60 mt-1">Dedicated iOS & Android apps launching later</p>
            </div>
            <ul className="space-y-2 text-xs text-white/70 font-sans">
              <li className="flex items-center gap-2">
          ...
          <div className="space-y-2 pt-4 border-t border-white/10">
            <div className="w-full bg-white/5 text-white/50 font-mono py-3 px-4 rounded-xl text-xs text-center border border-white/10">
              Coming in a Future Update
            </div>
            <span className="block text-[10px] text-center text-white/40 font-mono">Stay tuned for release news</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs text-white/70">
          <div className="space-y-2">
            <h4 className="font-mono font-bold text-white">1. Launch Workspace</h4>
            <p>Click "Launch Web Workspace" above to immediately enter the Gonnng environment in your desktop or mobile web browser.</p>
          </div>
          <div className="space-y-2">
            <h4 className="font-mono font-bold text-white">2. Create Account or Sign In</h4>

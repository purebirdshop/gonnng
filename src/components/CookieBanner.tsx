        ...
        <div className="flex flex-col space-y-3.5">
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-xl bg-[#FF5C00]/20 border border-[#FF5C00]/40 flex items-center justify-center text-[#FF5C00] shrink-0">
          ...
          {attribution && (attribution.source || attribution.campaign) && (
            <div className="bg-white/5 border border-white/10 rounded-xl p-2.5 flex items-center gap-2 text-[11px] font-mono text-amber-300">
              <Megaphone className="w-3.5 h-3.5 shrink-0 text-[#FF5C00]" />
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 pt-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                onClick={onAcceptAll}
                className="flex-1 sm:flex-initial px-4 py-2 rounded-xl text-xs font-mono font-bold text-black bg-[#FF5C00] hover:bg-[#FF751A] shadow-lg shadow-[#FF5C00]/20 transition-all flex items-center justify-center gap-1 cursor-pointer"
              >
